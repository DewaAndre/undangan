  ...
  return (
    ...
    >
      <div className="mx-auto w-full sm:w-5/6 md:w-3/4 lg:max-w-[60rem]">
        ...
        <h2 className="mx-auto text-center great-vibes-regular text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-black font-bold mt-12 my-20 leading-tight">
          Om Shanti Shanti Shanti Om
        </h2>
        <h3 className="mx-auto text-center great-vibes-regular text-[#323332] text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold">
          Hitung Mundur
        </h3>
        <div className="flex justify-center items-center gap-4 mt-4 my-12 px-4 md:px-0">
