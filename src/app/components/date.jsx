  ...
  return (
    ...
    >
      <div className="bg-white mx-auto w-full sm:w-5/6 md:w-3/4 lg:max-w-[50rem] text-center mt-14 mb-14 p-8 rounded-lg">
        ...
        <h3 className="mx-auto text-center great-vibes-regular text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-black font-bold leading-tight"> {/* Disesuaikan ukuran heading */}
          Tanggal & Waktu
        </h3>
